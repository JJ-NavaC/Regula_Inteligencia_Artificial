public class Main {
    ...
    public static void main(String[] args) {
        ...
        MultipleLinealRegressionByCrammer multipleLinealRegressionByCrammer = new MultipleLinealRegressionByCrammer(x1, x2, _y);
        ...
        System.out.println("Formula Predict n = " + predict + ": " + multipleLinealRegressionByCrammer.getFormulaP());
